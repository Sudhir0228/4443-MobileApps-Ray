...
class MongoManager:
    ...
    def put(self, filter_query, update_data, upsert=False): #put, push, delete and add are some of the major requests.
        """
...
if __name__ == "__main__":
    ...
    #     "port": "27017",
    #     "db_name": "candy_store",
    #     "collection_name": "candies", put post delete are some of the major requests 
    # }
    ...
    if query == "0":
        ...
        data = mm.get(skip = 750,limit = 50,filter = {"_id":0,"name":1})
        print (data)
        ...
        categories = mm.get(sort_criteria=[("name", -1)], filter={"name": 1, "count": 1})
